    ...
    <div className="flex flex-col items-center gap-10 py-5 px-18 lg:flex-row lg:gap-14 lg:text-left xl:gap-40 lg:py-20">
      <div className="py-4 pl-4 self-stretch flex flex-col items-start flex-[1_0_0] lg:pl-32">
        <div className="py-4 flex flex-col items-start gap-4 lg:py-0 pl-4">
          ...
          >
            <a href="/about"><div className="flex py-1 px-2 items-start gap-2.5 rounded-[2.3125rem] border-2 border-blue-500 bg-white">
        ...
        className="flex flex-row gap-4 py-1 pl-4 md:py-4">
          <button className="py-2.5 px-5 rounded-lg bg-white border border-[#D0D5DD]"><a href="/register"><div className='flex gap-3'><div className='zoom-in'><figure className='pt-1'><FaAddressBook /></figure></div><div>Register</div></div></a></button>
